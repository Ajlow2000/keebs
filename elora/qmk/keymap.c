...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_myr(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   _______, _______, KC_DEL,  _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    ...
    [_GAME_OVERLAY] = LAYOUT_myr(
        ...
        KC_LSFT, _______, _______, _______, _______, _______, _______, _______, KC_F1,   KC_F11,  _______, _______, _______, _______, _______, KC_F4,
                                   XXXXXXX, KC_LCTL, KC_SPC,  L_SYM,   KC_LALT, KC_F2,   L_NAV,   NUM_SPC, KC_BSPC, XXXXXXX,
